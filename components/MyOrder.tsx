      ...
      <View style={styles.modalBg}>
        <View style={styles.modalCard}>
          ...
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>Order ID: {order.orderId}</Text>
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
            ...
            {/* Total */}
            <Text style={styles.totalBig}>Total: ₹{order.total}</Text>

            <Text style={styles.sectionTitle}>Shipping Details</Text>

            <Text style={styles.shippingText}>{order.shipping?.name}</Text>
            <Text style={styles.shippingText}>{order.shipping?.phone}</Text>
            <Text style={styles.shippingText}>{order.shipping?.address}</Text>
