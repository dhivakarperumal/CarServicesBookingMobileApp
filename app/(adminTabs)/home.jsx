...
export default function Home() {
  ...
  return (
    ...
    >
      {/* 🔹 STATS GRID */}
      <View style={styles.grid}>
        <StatCard title="Today Bookings" value={topStats.todayBookings} />
        <StatCard title="Today Customers" value={topStats.todayCustomers} />
        <StatCard title="Total Services" value={topStats.totalServices} />
        <StatCard title="Total Customers" value={topStats.totalCustomers} />
        <StatCard title="Total Employees" value={topStats.totalEmployees} />
        <StatCard title="Total Orders" value={topStats.totalOrders} />
        <StatCard
          title="Delivery Orders"
          value={topStats.totalDeliveryOrders}
        />
        <StatCard title="Total Products" value={topStats.totalProducts} />
      ...
      <View style={styles.quickGrid}>
        ...
        <QuickButton
          title="Vehicles"
          icon="car-outline"
          onPress={() => router.push("/(Add-Vehicle)/addVehicle")}
        />
      </View>
